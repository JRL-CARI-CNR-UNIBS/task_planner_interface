...
class MongoStatistics:
    ...
    def makeDynamicRiskUncertaintyChart(self,request):
        import pandas as pd
        import seaborn as sns
...
def main():
    ...
    coll_duration_name = "durations_long"
    coll_risk_name = "dynamics_long"
    ...
    rospy.Service("mongo_statistics/make_uncertainty_chart",SetBool,mongo_statistics.makeDynamicRiskUncertaintyChart) 
