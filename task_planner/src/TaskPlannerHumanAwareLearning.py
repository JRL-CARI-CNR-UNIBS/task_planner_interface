...
@dataclass
class TaskPlannerHumanAwareLearning(TaskPlannerHumanAware):
    ...
    def set_objective(self, lambda_value: float) -> None:
        ...
        if self.objective == Objective.SUM_T_START_END:
            ...
            self.model.addConstr(cost_function == cost_function_temp + sigma_index * lambda_value)
